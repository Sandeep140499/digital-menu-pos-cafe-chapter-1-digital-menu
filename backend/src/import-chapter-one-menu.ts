...
const menuData: MenuCategorySeed[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { name: 'Paneer Tikka', basePrice: 299, hasHalf: true, halfPrice: 179, description: '6" / 9"' },
      { name: 'Chicken Tikka', basePrice: 299, hasHalf: true, halfPrice: 179, description: '6" / 9"' },
      { name: 'Smoked Chicken', basePrice: 299, hasHalf: true, halfPrice: 179, description: '6" / 9"' },
    ],
  },
  {
    name: 'Maggi',
  ...
  },
  {
    ...
    slug: 'noodles',
    items: [
      { name: 'Veg Noodles', basePrice: 149, hasHalf: true, halfPrice: 89, description: 'Half / Full' },
      { name: 'Hakka Noodles', basePrice: 159, hasHalf: true, halfPrice: 89, description: 'Half / Full' },
      { name: 'Egg Noodles', basePrice: 159, hasHalf: true, halfPrice: 109, description: 'Half / Full' },
      { name: 'Paneer Noodles', basePrice: 169, hasHalf: true, halfPrice: 119, description: 'Half / Full' },
      { name: 'Chicken Noodles', basePrice: 169, hasHalf: true, halfPrice: 119, description: 'Half / Full' },
    ],
  },
  {
    name: 'Fried Rice',
    slug: 'fried-rice',
    items: [
      { name: 'Veg Fried Rice', basePrice: 149, hasHalf: true, halfPrice: 89, description: 'Half / Full' },
      { name: 'Egg Fried Rice', basePrice: 159, hasHalf: true, halfPrice: 99, description: 'Half / Full' },
      { name: 'Paneer Fried Rice', basePrice: 169, hasHalf: true, halfPrice: 109, description: 'Half / Full' },
      { name: 'Chicken Fried Rice', basePrice: 169, hasHalf: true, halfPrice: 109, description: 'Half / Full' },
    ],
  },
  {
    name: 'Hot Beverages',
