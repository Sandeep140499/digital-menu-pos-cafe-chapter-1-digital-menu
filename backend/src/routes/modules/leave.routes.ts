...
function validateAdvanceRule(leaveType: "SICK" | "CASUAL" | "PAID", startDate: Date): string | null {
...
async function notifyAdminsForNewLeave(params: {
  ...
  const leaveTypeLabel = params.leaveType === "SICK" ? "Sick Leave" : params.leaveType === "PAID" ? "Paid Leave" : "Casual Leave";
